...
This file provides guidance to coding agents (Codex, and any agent reading AGENTS.md) when working with code in this repository. Content is kept in sync with CLAUDE.md.
